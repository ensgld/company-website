    ...
    <>
      ...
      <section className="mx-auto grid min-h-0 w-[min(1120px,calc(100%-28px))] grid-cols-1 items-center gap-11 py-9 pb-[52px] md:w-[min(1120px,calc(100%-40px))] lg:min-h-[calc(100vh-150px)] lg:grid-cols-[minmax(0,0.9fr)_minmax(390px,1.1fr)] lg:pt-6">
        <div className="max-w-[630px]">
          ...
          <p className="max-w-[590px] text-[17px] leading-[1.7] text-muted max-sm:text-base">
            {home.description}
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 overflow-hidden rounded-lg border border-line bg-white shadow-card sm:grid-cols-3">
            {home.summaryItems.map((item) => (
              <div
                className="border-t border-line px-5 py-4 first:border-t-0 sm:border-l sm:border-t-0 sm:first:border-l-0"
                key={item.label}
              >
                <span className="mb-1 block text-[11px] font-extrabold uppercase tracking-[0.08em] text-accent">
                  {item.label}
                </span>
                <strong className="block text-sm leading-snug text-ink">
                  {item.value}
                </strong>
              </div>
            ))}
      ...
      <section className="mx-auto w-[min(1120px,calc(100%-28px))] border-t border-line py-[72px] pt-[58px] md:w-[min(1120px,calc(100%-40px))]">
          ...
          {home.highlights.map((item, index) => {
            ...
            return (
              ...
              <div className="mb-[18px] flex items-center justify-between gap-4">
                ...
                <span className="rounded-md bg-success-soft px-2.5 py-1 text-[11px] font-extrabold uppercase tracking-[0.06em] text-success">
      ...
      <ServiceProcess className="mx-auto w-[min(1120px,calc(100%-28px))] border-t border-line py-[72px] pt-[58px] md:w-[min(1120px,calc(100%-40px))]" />
